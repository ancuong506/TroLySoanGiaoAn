...
<div class="main-header">
    ...
    <p>Tác giả: Dương Nguyễn An Cường - Trường TH&THCS Sảng Tủng - ĐT: 0354900506</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dương Nguyễn An Cường - Trường TH&THCS Sảng Tủng - ĐT: 0354900506</div>", unsafe_allow_html=True)
